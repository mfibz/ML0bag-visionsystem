{
 "cells": [
  ...
  },
  {
   ...
   "metadata": {},
   "outputs": [],
   "source": "# Check if running in Colab\nimport sys\nimport os\nIN_COLAB = 'google.colab' in sys.modules\n\nproject_path = '/home/programming/ML0bag-visionsystem'\n\nif os.path.exists(os.path.join(project_path, '.git')):\n    # Project exists - pull latest changes\n    print(\"Pulling latest changes...\")\n    os.system(f'cd {project_path} && git pull')\nelif IN_COLAB:\n    os.system(f'git clone https://github.com/mfibz/ML0bag-visionsystem.git {project_path}')\nelse:\n    os.system(f'git clone https://github.com/mfibz/ML0bag-visionsystem.git {project_path}')\n\nos.chdir(project_path)\nprint(f\"Working directory: {os.getcwd()}\")"
  },
  {
   "cell_type": "code",
   "execution_count": null,
